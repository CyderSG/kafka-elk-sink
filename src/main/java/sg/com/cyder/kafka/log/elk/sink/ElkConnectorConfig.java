...
public class ElkConnectorConfig extends AbstractConfig {
	...
	public ElkConnectorConfig(ConfigDef config, Map<String, String> parsedConfig) {
		super(config, parsedConfig);
	}

	public ElkConnectorConfig(Map<String, String> parsedConfig) {
